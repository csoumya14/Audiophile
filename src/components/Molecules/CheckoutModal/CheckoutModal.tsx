...
export const CheckoutModal: React.FC<CheckoutModalProps> = ({ setModalOpen }) => {
  ...
  return (
    <>
      <StyledOverlay />
      <Container>
        <SuccessTick width="100" height="100" />
        <StyledHeading textLevel="h3">Thank you for your order</StyledHeading>
        <Banner textLevel="p">You will receive an email confirmation shortly</Banner>
        <ProductDetailsContainer>
          <ItemWrapper>
          ...
          <TotalWrapper>
            <StyledHeadingTotal textLevel="h6">Grand total</StyledHeadingTotal>
            <StyledPara textLevel="p">$ {totalPrice.toLocaleString()}</StyledPara>
          </TotalWrapper>
        </ProductDetailsContainer>
